...
def mostrar_tabela():
    ...
    colunas = ("Nome", "CPF", "Idade", "Altura", "Profissão", "Salário", "Gênero", "Cidade")
...
radiobutton_masc.grid(row=6, column=1, padx=10, sticky='w')
radiobutton_fem.grid(row=7, column=1, padx=10, sticky='w')

label_cidade = tk.Label(janela, text="Cidade:")
label_cidade.grid(row=8, column=0, padx=10, pady=5, sticky='e')
...
optionmenu_cidades.grid(row=8, column=1, padx=10, pady=5)
